...
public class AssociatedObjectViewHolder<T extends ViewHolderItem> extends ParentViewHolder<T> {

    public AssociatedObjectViewHolder(BaseViewHolder<T> innerViewHolder) {
